...
<main class="main-section">
            ...
            <script>
                $(document).ready(function(){
                    ...
                    $('#curso').on('change', function(){
                        ...
                        $.ajax({
                            type: 'GET',
                            url: '/cead_template2/disciplina/get_by_categoria',
                    ...
                    $('#registar').on('click', function(){
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '/cead_template2/contrato/ver_lab_save',
    ...
    <script>
        function pdf(id){
             window.location.href = "/cead_template2/contrato/gerar_pdf_lab?id_docente="+id;
        }
